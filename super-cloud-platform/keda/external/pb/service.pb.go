...
const file_proto_service_proto_rawDesc = "" +
	"\n" +
	"\x13proto/service.proto\x12\bexternal\"\xdd\x01\n" +
	"\x0fScaledObjectRef\x12\x12\n" +
	"\x04name\x18\x01 \x01(\tR\x04name\x12\x1c\n" +
	"\tnamespace\x18\x02 \x01(\tR\tnamespace\x12U\n" +
	"\x0escalerMetadata\x18\x03 \x03(\v2-.external.ScaledObjectRef.ScalerMetadataEntryR\x0escalerMetadata\x1aA\n" +
	...
	"\vmetricSpecs\x18\x01 \x03(\v2\x14.external.MetricSpecR\vmetricSpecs\"L\n" +
	"\n" +
	"MetricSpec\x12\x1e\n" +
	"\n" +
	...
	"\x0fscaledObjectRef\x18\x01 \x01(\v2\x19.external.ScaledObjectRefR\x0fscaledObjectRef\x12\x1e\n" +
	"\n" +
	"metricName\x18\x02 \x01(\tR\n" +
	"metricName\"O\n" +
	"\x12GetMetricsResponse\x129\n" +
	"\fmetricValues\x18\x01 \x03(\v2\x15.external.MetricValueR\fmetricValues\"O\n" +
	"\vMetricValue\x12\x1e\n" +
	"\n" +
	"metricName\x18\x01 \x01(\tR\n" +
	"metricName\x12 \n" +
	"\vmetricValue\x18\x02 \x01(\x03R\vmetricValue2\xbc\x02\n" +
	"\x0eExternalScaler\x12C\n" +
	"\bIsActive\x12\x19.external.ScaledObjectRef\x1a\x1a.external.IsActiveResponse\"\x00\x12K\n" +
	"\x0eStreamIsActive\x12\x19.external.ScaledObjectRef\x1a\x1a.external.IsActiveResponse\"\x000\x01\x12M\n" +
	"\rGetMetricSpec\x12\x19.external.ScaledObjectRef\x1a\x1f.external.GetMetricSpecResponse\"\x00\x12I\n" +
	"\n" +
	"GetMetrics\x12\x1b.external.GetMetricsRequest\x1a\x1c.external.GetMetricsResponse\"\x00B\x06Z\x04./pbb\x06proto3"
...
var file_proto_service_proto_goTypes = []any{
	(*ScaledObjectRef)(nil),       // 0: external.ScaledObjectRef
	(*IsActiveResponse)(nil),      // 1: external.IsActiveResponse
	(*GetMetricSpecResponse)(nil), // 2: external.GetMetricSpecResponse
	(*MetricSpec)(nil),            // 3: external.MetricSpec
	(*GetMetricsRequest)(nil),     // 4: external.GetMetricsRequest
	(*GetMetricsResponse)(nil),    // 5: external.GetMetricsResponse
	(*MetricValue)(nil),           // 6: external.MetricValue
	nil,                           // 7: external.ScaledObjectRef.ScalerMetadataEntry
}
var file_proto_service_proto_depIdxs = []int32{
	7, // 0: external.ScaledObjectRef.scalerMetadata:type_name -> external.ScaledObjectRef.ScalerMetadataEntry
	3, // 1: external.GetMetricSpecResponse.metricSpecs:type_name -> external.MetricSpec
	0, // 2: external.GetMetricsRequest.scaledObjectRef:type_name -> external.ScaledObjectRef
	6, // 3: external.GetMetricsResponse.metricValues:type_name -> external.MetricValue
	0, // 4: external.ExternalScaler.IsActive:input_type -> external.ScaledObjectRef
	0, // 5: external.ExternalScaler.StreamIsActive:input_type -> external.ScaledObjectRef
	0, // 6: external.ExternalScaler.GetMetricSpec:input_type -> external.ScaledObjectRef
	4, // 7: external.ExternalScaler.GetMetrics:input_type -> external.GetMetricsRequest
	1, // 8: external.ExternalScaler.IsActive:output_type -> external.IsActiveResponse
	1, // 9: external.ExternalScaler.StreamIsActive:output_type -> external.IsActiveResponse
	2, // 10: external.ExternalScaler.GetMetricSpec:output_type -> external.GetMetricSpecResponse
	5, // 11: external.ExternalScaler.GetMetrics:output_type -> external.GetMetricsResponse
